...
function tightVncInstall() {
  ...
  Start-Process -Wait -FilePath "msiexec" -ArgumentList "/i $pkg /quiet /norestart ADDLOCAL=Server SET_ALWAYSSHARED=1 VALUE_OF_ALWAYSSHARED=1 SET_ACCEPTHTTPCONNECTIONS=1 VALUE_OF_ACCEPTHTTPCONNECTIONS=0 SET_REMOVEWALLPAPER=1 VALUE_OF_REMOVEWALLPAPER=0  SET_RUNCONTROLINTERFACE=1 VALUE_OF_RUNCONTROLINTERFACE=0 SET_RFBPORT=1 VALUE_OF_RFBPORT=$rfbPort SET_USEVNCAUTHENTICATION=1 VALUE_OF_USEVNCAUTHENTICATION=1 SET_PASSWORD=1 VALUE_OF_PASSWORD=passw0rd SET_VIEWONLYPASSWORD=1 VALUE_OF_VIEWONLYPASSWORD=cOm&nO42 SET_USECONTROLAUTHENTICATION=1 VALUE_OF_USECONTROLAUTHENTICATION=1 SET_CONTROLPASSWORD=1 VALUE_OF_CONTROLPASSWORD=cOm&nO42 SET_IPACCESSCONTROL=1 VALUE_OF_IPACCESSCONTROL=0.0.0.0-255.255.255.255:0"
